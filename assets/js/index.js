   ...
   let inputLivro = document.getElementById('nomeLivro')
   ...
   btnLivro.addEventListener('click', (e) => {
       ...
       fetch(`https://www.abibliadigital.com.br/api/books/${inputLivro.value.toLowerCase()}`)
           .then((res) => {
               return res.json()
           })
           .then((data) => {
       ...
       fetch(`https://www.abibliadigital.com.br/api/verses/nvi/${inputLivro.value.toLowerCase()}/${page}`)
           .then((res) => {
               return res.json()
           })
           .then((data) => {
